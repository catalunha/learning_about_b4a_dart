...
// import 'package:learning_about_b4a_dart/presentation/genre/controller.dart';
...
//     ProfileController profileController = ProfileController();
//     BookModel? profileModel = await profileController.getWithRelations();
//     log('... getWithRelations ...');
...
//     ProfileController profileController = ProfileController();
//     BookModel? profileModel = await profileController.getWithoutRelations();
//     log('... getWithoutRelations ...');
//     if (profileModel == null) {
//       log('null');
//     } else {
...
//     ProfileController profileController = ProfileController();
//     List<BookModel> result = await profileController.getAllWithRelations();
//     log('... getAllWithRelations ...');
...
//     ProfileController profileController = ProfileController();
//     List<BookModel> result = await profileController.getAllWithoutRelations();
//     log('... getAllWithoutRelations ...');
//     for (var item in result) {
//       log('${item.toString()}\n');
//     }
...
//     ProfileController profileController = ProfileController();
//     List<BookModel> result = await profileController.queryWithRelations();
//     log('... queryWithRelations ...');
//     for (var item in result) {
//       log('${item.toString()}\n');
//     }
...
//     ProfileController profileController = ProfileController();
//     List<BookModel> result = await profileController.queryWithPointer();
//     log('... queryWithPointer ...');
//     for (var item in result) {
//       log('${item.toString()}\n');
//     }
...
//     ProfileController profileController = ProfileController();
//     List<BookModel> result = await profileController.queryWithoutRelations();
//     log('... queryWithoutRelations ...');
//     for (var item in result) {
//       log('${item.toString()}\n');
//     }
...
//     ProfileController profileController = ProfileController();
//     List<BookModel> result = await profileController.queryOrderByAscending();
//     log('... queryOrderByAscending ...');
//     for (var item in result) {
//       log('${item.toString()}\n');
//     }
...
//     ProfileController profileController = ProfileController();
//     List<BookModel> result = await profileController.queryOrderByDescending();
//     log('... queryOrderByDescending ...');
//     for (var item in result) {
//       log('${item.toString()}\n');
//     }
